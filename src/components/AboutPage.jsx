export default function AboutPage() {
  return (
    <div className="w-full max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8 sm:p-10 border border-gray-200">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-6">About BillWise</h1>
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-3xl font-bold text-gray-800 pt-6">Our Commitment to Anonymity</h2>
        <p>
